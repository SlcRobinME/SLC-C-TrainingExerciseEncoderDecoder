...
public static class QAction
{
    ...
    public static void Run(SLProtocol protocol)
    {
        ...
        {
            double newEncoderBitrate = Math.Round(rng.NextDouble() * (ushort)ParamState.RandomBitrateMultiplier, 3);
        ...
        {
            double newDecoderBitrate = Math.Round(rng.NextDouble() * (ushort)ParamState.RandomBitrateMultiplier, 3);
            protocol.SetParameters(
